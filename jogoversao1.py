...
if idade < 15:
    ...
    personagem = int(input('Agora nos diga quem você quer ser?\nTrinity{1} ou Jesse{2}: '))
    ...
    if personagem == 1:
        ...
        esc = int(input('Voce tem que decidir pra onde ir, o que voce escolhe?\n1)Em frente\n2)Voltar\nResposta: '))
        ...
        if esc == 1:
            ...
            if esc1 == 1:
                ...
                if esc2 == 1: 
                    ...
                    esc3 = int(input('Eros então te olha de cima a baixo e se oferece a te ajudar a encontrar a sua sala.\nVocê aceita?\n1)Sim\n2)Não\nResposta: '))
                    
                    if esc3 == 1:
                        print('\nVocê e Eros então se despedem dos seus mais novos amigos e partem em direção na busca de sua sala')
                        esc4 = int(input('Voces caminham por mais 5 minutos e então chegam em frente a uma porta onde está escrito: Etica e Moral Socratica 101. Voce se volta para Eros com a intenção de agradecê-lo e então sente seu corpo sendo puxado para frente e então a boca dele encontra a sua.O que voce faz?\n1)Se entrega ao beijo.\n2)O afasta e entra correndo pra dentro sala.\nResposta: '))
                            ...
                            if esc5 == 1:
                                ...
                                if esc6 == 1:
                                    ...
                                    if esc7 == 1:
                                        ...
                                        esc8 = int(input('O que voce vai fazer?\n1)Tomar um banho.\n2)Permanecer como está e ir dormir.\nResposta: '))
                                        if esc8 == 1:
                                            ...
                                            if esc9 == 1:
                                                ...
                                                if esc10 == 1:
                                                    ...
                                                    if esc11 == 1:
                                                        ...
                                                        esc12 = int(input('Você tem certeza de que quer ir?\n1)Sim\n2)Não\nResposta: '))
                                                        ...
                                                        if esc12 == 1:
                                                            ...
                                                            esc13 = int(input('Você sabe que não conseguirá tirar a menina antes que a escada desabe. O que voce faz?\n1)Pega a menina nos braços e tenta correr\n2)Corre para longe\nResposta: '))

                                                            if esc13 == 1:
                                                                print('Você não vai abandoná-la, como você viveria sabendo que abandonou um ser humano para a morte? Você junta todas as suas forças e pega aquela menina, ela grita com a dor, você não era nenhuma médica, mas achava que ela tinha quebrado algumas costelas. Ao colocá-la nos braços, seus pés já estão em movimento, você corre...\ntenta sair dalí...\n...e por pouco você consegue com a escada desabando no exato momento em que você sai debaixo dela.\nVocê respira aliviada...\n\n\nUM CLARÃO SEGUIDO DE UM SOM ESTRONDOSO...\n\n\n\nVocê consegue se mexer e ao olhar para baixo percebe que suas pernas não estão mais lá, a menina que estava em seus braços está destroçada em seu peito...\nSua respiração começa a ficar mais lenta...\nSeus olhos ficam pesados...\nVocê tem um últimi pensamento enquanto sua mente fica nublada:"Por que?"')
        ...
        print('oi')
		#Adicionar \n nos prints depois de dado um input pra ficar bonitinho	
print('\nObrigado por jogar !')
